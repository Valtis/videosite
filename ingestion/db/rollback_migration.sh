...
DB_URL="postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}:${DB_PORT}/ingestion_db?sslmode=${SSL_MODE}"

SCRIPT_DIRECTORY="$(dirname "$(readlink -f "$0")")"


migrate -source "file://${SCRIPT_DIRECTORY}/ingestion" -database "${DB_URL}" down 1